...
class Settings:
    ...
    us_stock_universe: str = os.getenv("US_STOCK_UNIVERSE", "AAPL,MSFT,NVDA,AMZN,META,GOOGL,TSLA,AVGO,AMD,NFLX,ADBE,ORCL,CRM,INTC,QCOM,CSCO,IBM,UBER,SHOP,PLTR,COST,WMT,JPM,BAC,GS,LLY,UNH,XOM,CVX,BA")
